import { TableModel, ColumnModel , EnumFieldType } from '../../sui/sui.table/sui.table.model';
...
export class TableSampleComponent {
  getTableModel() {
      ...
      new ColumnModel('picture', 'Picture', EnumFieldType.Image),
      new ColumnModel('age', 'Age', EnumFieldType.Number),
      new ColumnModel('eyeColor', 'EyeColor'),
